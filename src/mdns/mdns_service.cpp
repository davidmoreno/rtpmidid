...
bool mdns::service::equal(const mdns::service *other) { return false; }
...
mdns::service_srv::service_srv(std::string label_, uint32_t ttl_,
...
mdns::service_ptr::service_ptr(std::string label_, uint32_t ttl_,
...
mdns::service_txt::service_txt(std::string label_, uint32_t ttl_,
                               std::string txt_)
